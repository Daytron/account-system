...
public enum AccountType {
    BUSINESS("Business",
            "0.0256", 
            new Money(Sign.Positive, 600, 00), 
    ...
    IRA("IRA", 
            "0.082", 
            new Money(Sign.Positive, 800, 00),
            new Money(Sign.Negative, 300, 00)),
    SMB("SMB", 
            "0.0234", 
            new Money(Sign.Positive, 420, 00), 
    ...
    CASH_INVESTMENT("Cash investment", 
            "0.0123",
            new Money(Sign.Positive, 250, 00), 
            new Money(Sign.Negative, 200, 00)),
    CHILD("Child", 
            "0.0123",
            new Money(Sign.Positive, 200, 00), 
    ...
    INTERNATIONAL("International", 
            "0.0123",
            new Money(Sign.Positive, 200, 00), 
            new Money(Sign.Negative, 100, 00));
